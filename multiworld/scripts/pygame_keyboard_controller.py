...
# env = gymnasium.make('Point2D-Big-UWall-v1')
# env = gymnasium.make('FiveObjectPickAndPlaceRandomInit1DEnv-v1')
# env = gymnasium.make('OneObject-PickAndPlace-OnRandomObjectInit-2D-v1')
env = gymnasium.make('OneObject-PickAndPlace-OriginInit-2D-v1')
# env = PickAndPlaceEnv(
#     num_objects=3,
#     render_size=240,
