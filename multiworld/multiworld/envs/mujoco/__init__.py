...
def register_mujoco_envs():
    ...
    if REGISTERED:
        return
    REGISTERED = True
    LOGGER.info("Registering multiworld mujoco gymnasium environments")
...
def register_development_sawyer_envs():
    ...
    register(
        ...
        kwargs=dict(
            wrapped_env=gymnasium.make('SawyerPushNIPSEasy-v0'),
            imsize=48,
...
def create_image_48_sawyer_reach_xy_env_v1():
    ...
    wrapped_env = gymnasium.make('SawyerReachXYEnv-v1')
    return ImageEnv(
        wrapped_env,
        48,
...
def create_image_48_sawyer_push_and_reach_arena_env_v0():
    ...
    wrapped_env = gymnasium.make('SawyerPushAndReachArenaEnv-v0')
    return ImageEnv(
        wrapped_env,
        48,
...
def create_image_48_sawyer_push_and_reach_arena_env_reset_free_v0():
    ...
    wrapped_env = gymnasium.make('SawyerPushAndReachArenaResetFreeEnv-v0')
    return ImageEnv(
        wrapped_env,
        48,
        init_camera=sawyer_pusher_camera_upright_v2,
...
def create_image_48_sawyer_door_hook_reset_free_v1():
    ...
    return ImageEnv(
        wrapped_env=gymnasium.make('SawyerDoorHookResetFreeEnv-v1'),
        imsize=48,
...
def create_image_48_sawyer_pickup_easy_v0():
    ...
    goals = np.load(goal_path).item()
    return ImageEnv(
        wrapped_env=gymnasium.make('SawyerPickupEnvYZEasyFewGoals-v0'),
        imsize=48,
