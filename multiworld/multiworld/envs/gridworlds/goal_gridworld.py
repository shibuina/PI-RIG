...
class GoalGridworld(GoalEnv):
    """A goal-based environment. It functions just as any regular OpenAI gymnasium environment but it
    ...
    def __init__(self,  size=[10,10], concatenated=False):
        ...
        self.observation_space = gymnasium.spaces.Dict({'observation': observation_space, 
