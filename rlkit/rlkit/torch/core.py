...
class PyTorchModule(nn.Module, metaclass=abc.ABCMeta):
    ...
    def save_init_params(self, init_params):
        """
        Save initialization parameters for model reconstruction.
        This is a utility method used by various RLKit modules.
        
        Args:
            init_params: Dictionary of initialization parameters (typically from locals())
        """
